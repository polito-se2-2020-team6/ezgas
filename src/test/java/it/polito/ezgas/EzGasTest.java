...
@ActiveProfiles("test")
@SpringBootTest
public class EzGasTest extends TestCase {
    @Autowired
    ...
    public void init() {
        ...
        testAdmin.setReputation(testReputation);
   ...
   */
    ...
    public void testReportFuelPrice(){
        ...
        try{
            ...
            gasStationService.setReport(stationDto.getGasStationId(),2.0,2.0,2.0,2.0,2.0,user.getUserId());
    ...
    public void testObtainFuelPriceGeographicAreaInvalidLatNegative() throws GPSDataException{
        List<GasStationDto> list = gasStationService.getGasStationsByProximity(-100,testLon);
        fail();
    }
    @Test(expected = GPSDataException.class)
    ...
    public void testObtainFuelPriceGeographicAreaInvalidLonNegative() throws GPSDataException{
        List<GasStationDto> list = gasStationService.getGasStationsByProximity(testLat,-190);
        fail();
    }
    @Test(expected = GPSDataException.class)
    ...
    public void testObtainFuelPriceWithCoordinatesInvalidFuel() throws InvalidGasTypeException {
        try {
            List<GasStationDto> list = gasStationService.getGasStationsWithCoordinates(testLat,testLon,"Not Existing",testCarSharing);
    ...
    public void testObtainFuelPriceWithCoordinatesInvalidLatNegative() throws GPSDataException {
        try {
            List<GasStationDto> list = gasStationService.getGasStationsWithCoordinates(-100,testLon,"null","null");
    ...
    public void testObtainFuelPriceWithCoordinatesInvalidLonNegative() throws GPSDataException {
        try {
            List<GasStationDto> list = gasStationService.getGasStationsWithCoordinates(testLat,-190,"null","null");
        } catch (InvalidGasTypeException e) {
            e.printStackTrace();
        }
        fail();
    ...
    private double computeDependability(GasStationDto g, long ts) throws ParseException {
        ...
        double rep_points = (reputation + 5) / 10.0 * 100; // 0 for reputation -5, 100 for reputation +5
