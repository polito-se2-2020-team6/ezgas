...
1. Mapper testing -> UserMapper, LoginMapper, GasStationMapper (Individual test)
2. Service testing -> UserServiceImpl + UserMapper + LoginMapper, GasStationServiceimpl + GasStationMapper
3. Routine testing -> ScheduledTask 
4. API testing -> UserServiceimpl + GasStationServiceimpl
...
|    UC9.1    |             FR 5.2              |          testComputeNewDependability1(), testComputeNewDependability2()testComputeNewDependability3()testComputeNewDependability4()          |
|             |                                 |           testComputeNewDependability1()testComputeNewDependability1()testComputeNewDependability1()testComputeNewDependability1()           |
