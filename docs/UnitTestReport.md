...
|      Criteria      |       Boundary values       |
| :----------------: | :-------------------------: |
| Correct latitude1  |             -90             |
|                    | -90 + Double.MIN_INCREMENT  |
|                    |  90 - Double.MIN_INCREMENT  |
| Correct longitude1 |            -180             |
|                    | -180 + Double.MIN_INCREMENT |
|                    | 180 - Double.MIN_INCREMENT  |
| Correct latitude2  |             -90             |
|                    | -90 + Double.MIN_INCREMENT  |
|                    |  90 - Double.MIN_INCREMENT  |
| Correct longitude2 |            -180             |
|                    | -180 + Double.MIN_INCREMENT |
|                    | 180 - Double.MIN_INCREMENT  |
...
| :---------------: | :-----------------: | :-------------: | :--------------------------------------------------------: | :-------------------: |
|       = -90       |          -          |      Valid      |                       (-90, -180.0)                        | testlatLonCorrect1()  |
...
| -90 <= `lat` < 90 |       = -180        |      Valid      |                       (0.0, -180.0 )                       | testlatLonCorrect4()  |
| -90 <= `lat` < 90 | -180 <= `lon` < 180 |     Invalid     |                       (90.0, 180.0 )                       | testlatLonCorrect5()  |
